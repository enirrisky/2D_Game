 ...
 *     all the interfaces and events necessary to work with OpenGL.
 ************************************************************************/
#pragma once
#include "Point.h"
...
public:
	...
	void keyEvent(unsigned char key, bool fDown);
	void keyEvent();
	void keySpecialEvent(int key, bool fDown);
	...
	static void *p;                   // for client (game pointer)
...
private:
	...
	static bool         fullscreen;   // starts in fullscreen
	...
	static bool isFunctionOnePress;   //    "   f1         "
	static bool isEscPress;           //    "   esc        "
};
 ...
 * on to the client. Only some keys get registerd (see props in class).
 *************************************************************************/
